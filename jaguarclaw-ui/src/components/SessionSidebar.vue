...
function navTo(section: 'chat' | 'documents' | 'im') {
  if (section === 'chat') {
    router.push('/')
    ...
    <div class="app-rail">
      ...
      <div class="rail-nav">
        ...
        <button
          ...
          :class="{ 'nav-active': activeSection === 'im' }"
          @click="navTo('im')"
          title="IM"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path d="M3 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H8l-5 5V5z"
              stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <span v-if="imUnreadCount > 0 && activeSection !== 'im'" class="im-badge">
