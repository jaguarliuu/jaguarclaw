...
public class ProfileUpdateTool implements Tool {
    ...
    public ToolDefinition getDefinition() {
        return ToolDefinition.builder()
                .name("update_profile")
                .description("Rewrite the PROFILE.md to update what you know about the user.")
                .parameters(Map.of(
                        "type", "object",
                        "properties", Map.of(
                                "content", Map.of("type", "string",
                                        "description", "Full Markdown content to write to PROFILE.md"),
    ...
    public Mono<ToolResult> execute(Map<String, Object> args) {
        ...
        try {
            soulConfigService.writeProfileMd("main", content);
            String msg = String.format("PROFILE.md updated. Reason: %s. This change will affect future interactions.", reason);
            return Mono.just(ToolResult.success(msg));
        } catch (Exception e) {
            log.error("Failed to update PROFILE.md", e);
